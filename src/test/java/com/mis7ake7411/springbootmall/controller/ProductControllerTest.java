...
public class ProductControllerTest {
  ...
  public void getProducts_sorting() throws Exception {
    ...
    mockMvc.perform(requestBuilder)
           ...
           .andExpect(jsonPath("$.total", notNullValue()))
           .andExpect(jsonPath("$.result", hasSize(5)))
           .andExpect(jsonPath("$.result[0].id", equalTo(6)))
           .andExpect(jsonPath("$.result[1].id", equalTo(5)))
           .andExpect(jsonPath("$.result[2].id", equalTo(7)))
           .andExpect(jsonPath("$.result[3].id", equalTo(4)))
           .andExpect(jsonPath("$.result[4].id", equalTo(2)));
  }
  ...
  public void getProducts_pagination() throws Exception {
    ...
    mockMvc.perform(requestBuilder)
           ...
           .andExpect(jsonPath("$.total", notNullValue()))
           .andExpect(jsonPath("$.result", hasSize(2)))
           .andExpect(jsonPath("$.result[0].id", equalTo(5)))
           .andExpect(jsonPath("$.result[1].id", equalTo(4)));
  }
}